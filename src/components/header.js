...
const Header = () => {
  ...
  const [ openMobileNav, setMobileNavVisibility ] = useState(0);
  ...
  const showMobileNav = () => {
    if ( openMobileNav ) {
      setMobileNavVisibility(0)
    } else {
      setMobileNavVisibility(1)
    }
  }
  ...
  return (
    ...
    <header className="navbar">
      <nav aria-hidden={openMobileNav ? false : true} className={`nav__mobile ${openMobileNav ? 'opened' : 'closed'}`}>
      ...
      <div className="container">
        <div className="navbar__inner">
          ...
          <div className="navbar__menu-mob">
            ...
            <div onClick={ () => showMobileNav() } id='toggle'>
